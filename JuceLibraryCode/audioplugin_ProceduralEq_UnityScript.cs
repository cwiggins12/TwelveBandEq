...
public class audioplugin_ProceduralEqGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_ProceduralEq"; } }
    public override string Description    { get { return "ProceduralEq"; } }
    public override string Vendor         { get { return "Cody Wiggins"; } }

    //==============================================================================
    [DllImport("audioplugin_ProceduralEq")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_ProceduralEq")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_ProceduralEq")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_ProceduralEq")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_ProceduralEq")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_ProceduralEq")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_ProceduralEq")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
